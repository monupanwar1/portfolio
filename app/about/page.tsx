          ...
          <div className="right w-full lg:w-1/2 flex flex-col items-start mt-8 lg:mt-0 px-4 lg:px-24 py-6">
            <div className="w-full">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 text-white">
                ...
                <h5 className="bg-[#232323] px-3 py-2 rounded-lg text-center">React</h5>
                <h5 className="bg-[#232323] px-3 py-2 rounded-lg text-center">Node.js</h5>
                <h5 className="bg-[#232323] px-3 py-2 rounded-lg text-center">Next.js</h5>
                <h5 className="bg-[#232323] px-3 py-2 rounded-lg text-center">GitHub</h5>
                <h5 className="bg-[#232323] px-3 py-2 rounded-lg text-center">Jira</h5>
                <h5 className="bg-[#232323] px-3 py-2 rounded-lg text-center">Prisma</h5>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 text-white">
                <h5 className="bg-[#232323] px-3 py-2 rounded-md text-center">Shadcn UI</h5>
               
                <h5 className="bg-[#232323] px-3 py-2 rounded-md text-center">Figma</h5>
                <h5 className="bg-[#232323] px-1 py-2 rounded-md text-center">Firebase</h5>
                <h5 className="bg-[#232323] px-3 py-2 rounded-md text-center">PHP</h5>
                <h5 className="bg-[#232323] px-3 py-2 rounded-md text-center">Angular</h5>
              </div>
            </div>
          </div>
        </div>
